...
def _validate_event_target(
    ...
    """
    Validate event target program/section.

    Rules:

        no program + no section
        ...
        program + section
            -> section must belong to program

        section without program
            -> invalid
    """
    ...
    if (
        ...
        raise BadRequestError(
            "target_program_id is required when "
            "target_section_id is provided"
        )
