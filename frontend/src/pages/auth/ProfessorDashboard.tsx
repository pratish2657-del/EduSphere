  ...
  return (
    <div className="professor-dashboard-page" style={styles.page}>
      <style>{`
        ...
        /* FINAL MOBILE/TABLET ALIGNMENT + OVERFLOW FIX */
        .professor-content,
        .professor-content * {
          min-width: 0 !important;
          max-width: 100%;
        ...
        @media (max-width: 900px) {
          ...
          .professor-stats-grid > div > div:nth-child(2) {
            min-width: 0 !important;
